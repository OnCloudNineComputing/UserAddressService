...
from database_services.UsersRDBServices import UsersRDBService
...
class UserResource(BaseRDBApplicationResource):
    ...
    @classmethod
    def get_by_user_id(cls, user_id, order_by=None, limit=None, offset=None, field_list=None):
        db_name, table_name = UserResource.get_data_resource_info()
        res = UsersRDBService.find_by_user_id(db_name, table_name, user_id, order_by, limit, offset, field_list)
        return res

    @classmethod
    def update_by_user_id(cls, user_id, data):
        db_name, table_name = UserResource.get_data_resource_info()
        res = UsersRDBService.update_by_user_id(db_name, table_name,
                                                user_id, data)
        return res
    ...
    def delete_by_user_id(cls, user_id):
        db_name, table_name = UserResource.get_data_resource_info()
        res = UsersRDBService.delete_by_user_id(db_name, table_name,
                                                user_id)
        return res
    ...
    def create(cls, data):
        ...
        res = UsersRDBService.create(db_name, table_name, data)
        return res

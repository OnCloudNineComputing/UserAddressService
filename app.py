...
def user_collection():
    ...
    if request.method == "GET":
        ...
        res = UserResource.create(request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
...
def specific_user(user_id):
    ...
    if request.method == "GET":
        ...
        res = UserResource.update_by_id(user_id, request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
...
@app.route('/users/<user_id>/addresses', methods=['GET', 'POST', 'PUT', 'DELETE'])
def specific_user_address(user_id):
    """
    :param user_id:
    :return:
    """
    if request.method == "GET":
        res = UserAddressResource.get_address_by_id(user_id)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'POST':
        res = UserAddressResource.create_address_by_id(user_id, request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'PUT':
        res = UserAddressResource.update_address_by_id(user_id, request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'DELETE':
        res = UserAddressResource.delete_address_by_id(user_id)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
...
def address_collection():
    """
    1. HTTP GET return all addresses.
    2. HTTP POST with body --> create an address, i.e --> database.
    :return:
    """
    if request.method == "GET":
        ...
        res = AddressResource.create(request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
...
def specific_address(address_id):
    ...
    """
    if request.method == "GET":
        res = AddressResource.get_by_id(address_id)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'PUT':
        res = AddressResource.update_by_id(address_id, request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'DELETE':
        res = UserAddressResource.delete_user_by_id(address_id)
        res = AddressResource.delete_by_id(address_id)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp


@app.route('/addresses/<address_id>/users', methods=['GET', 'POST', 'DELETE'])
def specific_address_users(address_id):
    """
    :param user_id:
    :return:
    """
    if request.method == "GET":
        res = UserAddressResource.get_user_by_id(address_id)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'POST':
        res = UserAddressResource.create_user_by_id(address_id, request.json)
        rsp = Response(json.dumps(res, default=str), status=200, content_type="application/json")
        return rsp
    elif request.method == 'DELETE':
        res = UserAddressResource.delete_user_by_id(address_id)
